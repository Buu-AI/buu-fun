...
export default function GoldOne() {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        {" "}
        <path d="M12 15C15.7279 15 18.75 12.0899 18.75 8.5C18.75 4.91015 15.7279 2 12 2C8.27208 2 5.25 4.91015 5.25 8.5C5.25 12.0899 8.27208 15 12 15Z"></path>{" "}
        <path
          opacity="0.6"
