...
export default function RoiStakingDialog() {
  ...
  return (
    ...
    >
      <DialogContent className="rounded-[20px] max-w-sm lg:rounded-[20px] px-0 pb-0 overflow-hidden   overflow-y-scroll scrollbar-w-hidden scrollbar-thumb-orange scrollbar-thumb-rounded max-h-[90vh]  border-buu bg-roi-shadow ">
