...
export const deriveStakePoolPDA = (
  ...
  return PublicKey.findProgramAddressSync(
    [
      ...
      mint.toBuffer(),
      authority.toBuffer(),
      new BN(nonce).toArrayLike(Buffer, "le", 1),
    ],
    programId,
  )[0];
};
...
export const deriveStakeVaultPDA = (
  ...
  return PublicKey.findProgramAddressSync(
    [STAKE_VAULT_PREFIX, stakePool.toBuffer()],
    programId,
  )[0];
};
...
export const deriveStakeMintPDA = (
  ...
  return PublicKey.findProgramAddressSync(
    [STAKE_MINT_PREFIX, stakePool.toBuffer()],
    programId,
  )[0];
};
...
export const deriveRewardVaultPDA = (
  ...
  return PublicKey.findProgramAddressSync(
    [REWARD_VAULT_PREFIX, rewardPool.toBuffer()],
    programId,
  )[0];
};
...
export const deriveFeeValuePDA = (
  ...
  return PublicKey.findProgramAddressSync(
    [FEE_VALUE_PREFIX, target.toBuffer()],
    programId,
  )[0];
};
